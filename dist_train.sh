...
# wait
# CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node=2 train.py --configs /data/code/semantic-segmentation-semi-supervised-learning/config/update/reinhard_match/train_reinhardmatch/effb1_bce.yaml
# wait
CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node=2 train.py --configs /data/code/semantic-segmentation-semi-supervised-learning/config/update/cyclegan/train_fake/unet/effb1_bce_t.yaml
