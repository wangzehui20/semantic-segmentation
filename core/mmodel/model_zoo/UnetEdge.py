...
class SegmentationModel(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        edges = self.edge_segmentation_head(decoder_output)
        # edges = ndimage.morphology.distance_transform_edt(masks.copy().numpy())
        # edges[edges > 2] = 0
        # edges[edges > 0] = 255
        return masks, edges
        # return masks, torch.from_numpy(edges)
...
if __name__ == '__main__':
    ...
    model = UnetEdge(encoder_name='efficientnet-b1')
    out = model(x)
