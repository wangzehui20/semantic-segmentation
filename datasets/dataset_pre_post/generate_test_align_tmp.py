...
if __name__ == '__main__':
    ...
    imori_dir = rf"{cfg.ORI_DIR}/val/image"
    imclp_dir = rf"{cfg.CLIP_DIR}/{cfg.FILE_NAME}/val/image"
    statis_path = rf"{cfg.CLIP_DIR}/{cfg.FILE_NAME}/val/test_statis.json"
    shiftul_path = rf"{cfg.CLIP_DIR}/{cfg.FILE_NAME}/val/test_shiftul.json"
    check_dir(imclp_dir)
